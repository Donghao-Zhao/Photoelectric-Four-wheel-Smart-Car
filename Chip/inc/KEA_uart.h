...
#ifndef __KEA_UART_H__
#define __KEA_UART_H__
...
//接收相关代码
extern void   uart_getchar   (UARTn_e, char *ch);                //等待接收1个字节
...
extern void uart0_test_handler(void);                        //中断服务函数，仅供参考（需用户自行实现）

/********************************************************************/

#endif /* __KEA_UART_H__ */
