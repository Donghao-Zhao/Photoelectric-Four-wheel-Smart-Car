...
extern uint32   last_tab;           

void var_init();


extern void     save_var(var_tab_e var_tal, uint32 var_data);       
extern void     get_var(var_tab_e var_tal, uint32 *var_data);       
extern void     updata_var(var_tab_e var_tal);                      

extern void     var_display(uint8 tab);                             
extern uint8    var_syn(uint8 tab);                                 



extern void     var_select(ui_var_event_e  ctrl);   
extern void     var_value(ui_var_event_e ctrl);     
extern void     var_ok();                           
extern void     val_cancel();                       


extern uint8    car_ctrl_get();                     
extern uint8    car_ctrl_syn(CAR_CTRL_MODE_e mode); 
...
extern void             nrf_msg_init();                                
extern nrf_result_e     nrf_msg_tx(com_e   com, uint8 *sendbuf);       
extern nrf_result_e     nrf_msg_rx(com_e  *com, uint8 *rebuf);         
...
void var_init()
{
    ...
    for(var_num = 0; var_num < VAR_MAX; var_num++)
    {
        ...
        if (!(num_info[var_num]. maxval >= num_info[var_num]. minval)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_UI_VAR.c", 61);
    }
}
...
void save_var(var_tab_e var_tal, uint32 var_data)
{
    ...
    num_info[var_tal]. val = var_data;
    num_info[var_tal]. oldval = var_data;
}
...
void updata_var(var_tab_e var_tal)
{
    ...
    num_info[var_tal]. val = vartemp;
}


void var_value(ui_var_event_e ctrl)
{
    if (!(new_tab < VAR_MAX)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_UI_VAR.c", 113);
    ...
    {
    case VAR_ADD:
        if(num_info[new_tab]. val < num_info[new_tab]. maxval)
        {
            num_info[new_tab]. val++;
        }
        else
        {
            num_info[new_tab]. val = num_info[new_tab]. minval;
        }
        break;

    case VAR_SUB:
        if(num_info[new_tab]. val > num_info[new_tab]. minval)
        {
            num_info[new_tab]. val--;
        }
        else
        {
            num_info[new_tab]. val = num_info[new_tab]. maxval ;
        }
        break;

    case VAR_ADD_HOLD:
        if(   (num_info[new_tab]. maxval - num_info[new_tab]. val)  >  10 )
        {
            num_info[new_tab]. val += 10;
        }
        else
        {
            num_info[new_tab]. val = num_info[new_tab]. minval;
    ...
    case VAR_SUB_HOLD:
        if( ( num_info[new_tab]. val - num_info[new_tab]. minval) > 10  )
        {
            num_info[new_tab]. val -= 10;
        }
        else
...
{
    if (!(new_tab < VAR_MAX)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_UI_VAR.c", 173);

    uint8 old_tab = new_tab;       
...
void var_ok()
{
    if (!(new_tab < VAR_MAX)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_UI_VAR.c", 226);

    
    if(num_info[new_tab]. val != num_info[new_tab]. oldval)   
    {
        var_syn(new_tab);          
    }
...
void val_cancel()
{
    if (!(new_tab < VAR_MAX)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_UI_VAR.c", 240);

    
    num_info[new_tab]. val = num_info[new_tab]. oldval;
...
void var_display(uint8 tab)
{
    ...
    if (!((new_tab < VAR_MAX) && (tab <= VAR_MAX))) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_UI_VAR.c", 272);
    ...
    do
    {
        if(tab == new_tab)
        {
            ...
            if(num_info[tab]. val == num_info[tab]. oldval) 
            {
                Color   =  0X001F;
                bkColor =  0XFFFF;
            }
        ...
        lcd_num_bc(num_info[tab]. site, num_info[tab]. val,5,Color,bkColor);
...
void save_var2buff(var_tab_e var_num, uint8 *sendbuf)
{
    ...
    *((uint32 *)&sendbuf[2]) = (uint32)var_num;
    *((uint32 *)&sendbuf[2 + sizeof(uint32)]) = temp;
}


uint8 var_syn(uint8 tab)
{
    if (!((new_tab < VAR_MAX) && (tab <= VAR_MAX))) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_UI_VAR.c", 334);
    ...
    do
    {
        oldvalue = num_info[tab]. oldval;                   

        
        save_var((var_tab_e)tab, num_info[tab]. val);

        
        save_var2buff((var_tab_e)tab, tempbuff);        
        nrf_msg_tx(COM_VAR, tempbuff);                

        while(nrf_tx_state() == NRF_TXING);             

        if(NRF_TX_ERROR == nrf_tx_state())             
        {
            num_info[tab]. oldval = oldvalue;               
...
{
    uint8 ret;
    if (!(mode < CAR_CTRL_MAX)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_UI_VAR.c", 383);

    num_info[CAR_CTRL]. val =  mode;
