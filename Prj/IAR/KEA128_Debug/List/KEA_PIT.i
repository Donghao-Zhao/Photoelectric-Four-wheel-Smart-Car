...
void pit_ch0_irq()
{
     ...
     countL = ftm_pulse_get(((FTM_Type *)(0x40038000u)));
     countR = ftm_pulse_get(((FTM_Type *)(0x40039000u)));
     ...
     if(gpio_get(PTG5))
      {
        LED_PrintValueI(30, 0,ADC_value[0]);
        ...
        else
       {
        ...
        pp[2]=60;
        Data_Send(((UART_Type *)(0x4006C000u)),pp);
       } 
     ((((PIT_Type *)(0x40037000u)))->CHANNEL[PIT0]. TFLG)|=0x1u;   
     ftm_clean(((FTM_Type *)(0x40038000u)));  
     ftm_clean(((FTM_Type *)(0x40039000u))); 
...
void pit_ch1_irq()
{
      ...
      Read_2100_8700(0x20,bit8_data,bit16_data16);

      gyro_z_h=bit8_data[2];
      gyro_z_l=bit8_data[3];

      gyro_z=((unsigned short)gyro_z_h<<8)|gyro_z_l;
      


      Read_2100_8700(0x1e,bit8_data,bit16_data16);
...
void pit_init(PITn_e pitn, uint32 cnt)
{
    ...
    if (!(cnt > 0)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_PIT.c", 215);                          

    ((((SIM_Type *)(0x40048000u)))->SCGC)       |= 0x2u;          

    ((((PIT_Type *)(0x40037000u)))->MCR)         = (0
                       
                       
                      );

    ((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. LDVAL)  = cnt - 1 ;                    

    ((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. TFLG)|=0x1u;                           

    ((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. TCTRL) &= ~ 0x1u;        
    ((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. TCTRL)  = ( 0
                         | 0x1u        
                         | 0x2u        
                       );
...
void pit_delay(PITn_e pitn, uint32 cnt)
{
    ...
    if (!(cnt > 0)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_PIT.c", 250);              

    ((((SIM_Type *)(0x40048000u)))->SCGC)       |= 0x2u;          

    ((((PIT_Type *)(0x40037000u)))->MCR)         &= ~(0x2u | 0x1u );    
    ...
    while( !(((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. TFLG)& 0x1u));
...
void pit_time_start(PITn_e pitn)
{
    ...
    ((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. LDVAL)  = ~0;                                          
...
uint32 pit_time_get(PITn_e pitn)
{
    ...
    val = (~0) - ((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. CVAL);

    if(((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. TFLG)& 0x1u)                           
    {
        ((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. TFLG)|=0x1u;                                       
        ((((PIT_Type *)(0x40037000u)))->CHANNEL[pitn]. TCTRL) &= ~ 0x1u;                    
        return ~0;
