...
void ics_init(void)
{
    ...
    ((SIM_Type *)(0x40048000u))->CLKDIV =   (0
                     | (((uint32_t)(((uint32_t)(0x00))<<28))&0x30000000u)                 
                     | (1<<24)   
                     | (1<<20)    
                    );

     
    ((ICS_Type *)(0x40064000u))->C2 = (0
               |   (((uint8_t)(((uint8_t)(0x0))<<5))&0xE0u)
               
              );

    ((OSC_Type *)(0x40065000u))->CR = (0
               | 0x80u     
               | 0x10u     
               | 0x4u     
               | 0x2u       
    ...
    ((ICS_Type *)(0x40064000u))->C1 = ( 0
                
                | (((uint8_t)(((uint8_t)(0x00))<<6))&0xC0u)     
                | (((uint8_t)(((uint8_t)(0x02))<<3))&0x38u)
                | 0x2u
              );

    while((((ICS_Type *)(0x40064000u))->S & 0x10u) != 0x00U) {}      
    while((((ICS_Type *)(0x40064000u))->S & 0xCu) != 0x00U) {}       


    core_clk_khz = 80*1000;
    core_clk_mhz = 80;
    bus_clk_khz = core_clk_khz / (1+1);
    timer_clk_khz = core_clk_khz / (1+1);
...
void sysinit (void)
{
    ...
    uart_init (((UART_Type *)(0x4006A000u)), 115200);   
}
