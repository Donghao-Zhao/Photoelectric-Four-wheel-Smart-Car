...
{					     
  gpio_init(PTH3,GPI,1u);
  gpio_init(PTH4,GPO,1u);
  ((PORT_Type *)(0x40049000u))->PUE1 |= (uint32)(1<<((PTH3)&0x7));
}


void MPU_IIC_Start(void)
{
  gpio_init(PTH3,GPO,1u);     
  (((Dtype *)(&(GPIOX[1]->PDOR )))->b27)=1;	  	  
  (((Dtype *)(&(GPIOX[1]->PDOR )))->b28)=1;
  MPU_IIC_Delay();
  (((Dtype *)(&(GPIOX[1]->PDOR )))->b27)=0;
  MPU_IIC_Delay();
  (((Dtype *)(&(GPIOX[1]->PDOR )))->b28)=0;
}	  
...
{                        
  ...
  for(t=0;t<8;t++)
  {              
    (((Dtype *)(&(GPIOX[1]->PDOR )))->b27)=(txd&0x80)>>7;
    txd<<=1; 	  
    (((Dtype *)(&(GPIOX[1]->PDOR )))->b28)=1;
    MPU_IIC_Delay(); 
    (((Dtype *)(&(GPIOX[1]->PDOR )))->b28)=0;	
...
uint8_t MPU_IIC_Read_Byte(unsigned char ack)
{
  ...
  for(i=0;i<8;i++ )
  {
    ...
    (((Dtype *)(&(GPIOX[1]->PDOR )))->b28)=1;
    receive<<=1;
    if((((Dtype *)(&(GPIOX[1]->PDIR )))->b27))receive++;   
    MPU_IIC_Delay(); 
  }					 
  if (!ack)
    MPU_IIC_NAck();
