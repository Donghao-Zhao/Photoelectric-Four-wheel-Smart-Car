...
uint16  st7735s_h   = 128;
uint16  st7735s_w   = 128;
uint8   st7735s_dir = 0;
...
{
    if (!(option < 4)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_LCD_ST7735S.c", 197);
