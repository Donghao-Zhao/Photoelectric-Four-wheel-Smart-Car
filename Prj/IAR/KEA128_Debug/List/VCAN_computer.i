...
void vcan_sendimg(void *imgaddr, uint32_t imgsize)
{
    ...
    uart_putbuff(((UART_Type *)(0x4006A000u)), cmdf, sizeof(cmdf));    

    uart_putbuff(((UART_Type *)(0x4006A000u)), (uint8_t *)imgaddr, imgsize); 

    uart_putbuff(((UART_Type *)(0x4006A000u)), cmdr, sizeof(cmdr));    
}
...
void vcan_sendccd(void *ccdaddr, uint32_t ccdsize)
{
    ...
    uart_putbuff(((UART_Type *)(0x4006A000u)), (uint8_t *)ccdaddr, ccdsize); 
...
void vcan_sendware(void *wareaddr, uint32_t waresize)
{
    ...
    uart_putbuff(((UART_Type *)(0x4006A000u)), cmdf, sizeof(cmdf));    
    uart_putbuff(((UART_Type *)(0x4006A000u)), (uint8_t *)wareaddr, waresize);    
    uart_putbuff(((UART_Type *)(0x4006A000u)), cmdr, sizeof(cmdr));    
