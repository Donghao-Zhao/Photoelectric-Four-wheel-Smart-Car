...
{
    uint32_t volatile *port_pue[] = {&((((PORT_Type *)(0x40049000u)))->PUE0), &((((PORT_Type *)(0x40049000u)))->PUE1), &((((PORT_Type *)(0x40049000u)))->PUE2)};

    if(0  == cfg)
    {
        *port_pue[((ptxn)>>5)] &= ~(1 << ((ptxn)&0x1f));
    }
    else if(1  == cfg)
    {
        *port_pue[((ptxn)>>5)] |= (1 << ((ptxn)&0x1f));
...
char port_hdrve(PTXn_e ptxn, char  cfg)
{
    ...
    for(i = 0; i < sizeof(ptxns); i++)
    {
        if(ptxns[i] == ptxn)
        {
            if(0  == cfg)
            {
                ((((PORT_Type *)(0x40049000u)))->HDRVE) &= ~(1 << i);
            }
            else
            {
                ((((PORT_Type *)(0x40049000u)))->HDRVE) |= (1 << i);
