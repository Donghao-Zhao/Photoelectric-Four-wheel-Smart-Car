...
void ftm_port_mux(FTMn_e ftmn, FTM_CHn_e ch)
{
    ...
    case (uint32_t)((FTM_Type *)(0x40038000u)):
        ...
        case  FTM_CH0:
            ...
            break;
        case  FTM_CH1:
            if(PTA1 == PTA1) (((((SIM_Type *)(0x40048000u)))->PINSEL)) &= ~(1<<(9));
            else if(PTA1 == PTB3) (((((SIM_Type *)(0x40048000u)))->PINSEL)) |= (1<<(9));
            break;
    ...
    case (uint32_t)((FTM_Type *)(0x40039000u)):
        ...
        case  FTM_CH0:
            ...
            break;
        case  FTM_CH1:
            if(PTE7 == PTC5) (((((SIM_Type *)(0x40048000u)))->PINSEL)) &= ~(1<<(11));
            else if(PTE7 == PTE7) (((((SIM_Type *)(0x40048000u)))->PINSEL)) |= (1<<(11));
            break;
    ...
    case (uint32_t)((FTM_Type *)(0x4003A000u)):
        ...
        case  FTM_CH1:
            ...
            if(PTC1 == PTC1) ((((SIM_Type *)(0x40048000u)))->PINSEL1) |= (((uint32_t)(((uint32_t)(0))<<2))&0xCu);
            else if(PTC1 == PTF1) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(2))<<2))&0xCu);
            else if(PTC1 == PTH1) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(1))<<2))&0xCu);
            break;
        case  FTM_CH2:
        ...
        case  FTM_CH4:
            ...
            else if(PTG6 == PTG6)   (((((SIM_Type *)(0x40048000u)))->PINSEL1)) |= (1<<(8));
            break;
        case  FTM_CH5:
            if(PTG6 == PTB5)        (((((SIM_Type *)(0x40048000u)))->PINSEL1)) &= ~(1<<(9));
            else if(PTG6 == PTG7)   (((((SIM_Type *)(0x40048000u)))->PINSEL1)) |= (1<<(9));
            break;
        }
...
void  ftm_pwm_finit(FTMn_e ftmn, FTM_CHn_e ch, uint32 freq, float duty)  
{
    ...
    if (!(ps <= 0x07)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 184);                 
...
void ftm_pwm_init(FTMn_e ftmn, FTM_CHn_e ch, uint32 freq, uint32 duty)
{
    ...
    if (!(ps <= 0x07)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 264);                 
...
void ftm_pwm_duty(FTMn_e ftmn, FTM_CHn_e ch, uint32 duty)
{
    ...
    case (uint32_t)((FTM_Type *)(0x40038000u)):
        if (!(duty <= 100u)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 343);     
        break;

    case (uint32_t)((FTM_Type *)(0x40039000u)):
        if (!(duty <= 100u)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 347);     
        break;
    case (uint32_t)((FTM_Type *)(0x4003A000u)):
        if (!(duty <= 5000u)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 350);     
        break;

    default:
        if (!(0)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 354);
        break;
    }
    ...
    default:
        if (!(0)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 402);
        break;
    }
...
void ftm_pwm_fduty(FTMn_e ftmn, FTM_CHn_e ch, float duty)
{
    ...
    if (!(duty <= 100.0)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 426);     
    ...
    default:
        if (!(0)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 457);
        break;
    }
...
void ftm_pwm_freq(FTMn_e ftmn, uint32 freq)             
{
    ...
    if (!(ps <= 0x07)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 492);                 
    ...
    default:
        if (!(0)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 511);
        break;
    }
...
{
    if (!((ftmn == ((FTM_Type *)(0x4003A000u))))) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_ftm.c", 544);  
