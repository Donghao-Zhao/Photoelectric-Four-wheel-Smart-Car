...
int16  AD_valu[5],AD_V[5][3],chazhi,chazhi_old;
float  AD[5],sensor_to_one[5];
float  Slope_AD_1;  
int16  maxmin[10];  
int16  Position_transit[4];  
int16  AD_sum[5]; 
int16  AD_MAX_NUM;   
...
void guiyihuaInit()
{
   uint16  i,j;
       ...
       maxmin[0] = maxmin[1] = maxmin[2]= maxmin[3]= maxmin[4]=0;
       ...
       data.sectornum_start    = (256) - 18;     
       data.sectornum_end    = (256) - 9;       
  
       data.data_addr      = &maxmin;                          
       data.data_size      = sizeof(maxmin);                  
    
      
     (*(flash_data_init_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->flash_data_init))) ))))(&data,bus_clk_khz);    
     if((*(flash_data_save_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->flash_data_save))) ))))(&data))
     {
       led(LED1, LED_OFF);
     }
...
{    
   ...
   if((*(flash_data_load_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->flash_data_load))) ))))(&data))    
   {    
    ...
    {    
        ...
        guiyihuaInit();
        (*(flash_data_load_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->flash_data_load))) ))))(&data) ;    
     }    
}
