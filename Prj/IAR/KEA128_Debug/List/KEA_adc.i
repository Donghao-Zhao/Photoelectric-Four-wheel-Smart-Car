...
static void  inline   adc_start   (ADCn_Ch_e, ADC_nbit);    
...
void adc_init(ADCn_Ch_e adcn_ch)
{
    ...
    if (!(adcn_ch < ADCn_Ch_MAX)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_adc.c", 34) ;

    ((((SIM_Type *)(0x40048000u)))->SCGC) |= 0x20000000u;  

    ((((ADC_Type *)(0x4003B000u)))->APCTL1) |= 1 << adcn_ch;     

    ((((ADC_Type *)(0x4003B000u)))->SC2) = (0
               
               |  (((uint32_t)(((uint32_t)(0))<<0))&0x3u)     
              );
}
...
uint16 adc_once(ADCn_Ch_e adcn_ch, ADC_nbit bit) 
{
    ...
    adc_start(adcn_ch, bit);      

    while (!( ((((ADC_Type *)(0x4003B000u)))->SC1) & 0x80u ));   
    result = ((((ADC_Type *)(0x4003B000u)))->R);
    ((((ADC_Type *)(0x4003B000u)))->SC1) &= ~0x80u;
    return result;
}
...
{
    ((ADC_Type *)(0x4003B000u))->SC3  = (0
                  |(((uint32_t)(((uint32_t)(0))<<0))&0x3u)            
                  |(((uint32_t)(((uint32_t)(bit))<<2))&0xCu)            
                  
                  |(((uint32_t)(((uint32_t)(0))<<5))&0x60u)              
                  
                  );
                  
    
    ((((ADC_Type *)(0x4003B000u)))->SC1)                     = (0
                                   | 0x40u          
                                   
                                   | (((uint32_t)(((uint32_t)(adcn_ch))<<0))&0x1Fu)
                                  );
...
void adc_stop(ADCn_e adcn)
{
    ((((ADC_Type *)(0x4003B000u)))->SC1) = (0
               ...
               | (((uint32_t)(((uint32_t)(Module0_Dis))<<0))&0x1Fu)               
              );
}
...
uint16 ADC_Mid(ADCn_Ch_e adc_ch,ADC_nbit bit) 
{
    uint16 i,j,k,tmp;
...
uint16 ADC_Ave(ADCn_Ch_e adc_ch,ADC_nbit bit,uint16 N) 
{
    uint32 tmp = 0;
    uint8  i;
