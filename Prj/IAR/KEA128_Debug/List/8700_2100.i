...
void Init_8700_2100()
{
  ...
  Write_Byte_2100_8700(0x1e,0x2A, 0x00);
  Write_Byte_2100_8700(0x1e,0x2A, 0x0f);
  Write_Byte_2100_8700(0x1e,0x5C,0x20);
  Write_Byte_2100_8700(0x1e,0x0E,0x01);
  Write_Byte_2100_8700(0x1e,0x2A,0x0d);
  
  Write_Byte_2100_8700(0x20,0X15, 0x40);
  Write_Byte_2100_8700(0x20,0X13, 0x01);
  soft_delay_ms(1);
  Write_Byte_2100_8700(0x20,0X13,0x03);   
}

void Read_2100_8700(unsigned char slave,unsigned char * p, short * q)
{
  int MUP_Zero=0x0000;
  p[0]  =    Read_Byte_2100_8700(slave,0x01);
  p[1]  =    Read_Byte_2100_8700(slave,0x02);
  p[2]  =    Read_Byte_2100_8700(slave,0x03);
  p[3]  =    Read_Byte_2100_8700(slave,0x04);
  p[4]  =    Read_Byte_2100_8700(slave,0x05);
  p[5]  =    Read_Byte_2100_8700(slave,0x06);
...
void Test_2100_8700(void)
{
  ...
  while(1)
  {
    ...
    LED_PrintValueI(30, 4,A1);
    LED_PrintValueI(30, 5,G1);
  }
}
