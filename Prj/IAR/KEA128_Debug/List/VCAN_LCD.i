...
extern void ftm_port_mux(FTMn_e ftmn, FTM_CHn_e ch);
...
void lcd_init(void)
{
    ...
    size.W = ST7735S_get_w();
    size.H = ST7735S_get_h();

    lcd_rectangle(site, size, 0XF800);     
}
...
void lcd_rectangle(Site_t site, Size_t size, uint16 rgb565)
{
    ...
    for(n = 0; n < temp; n++)
    {
        do{do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)((rgb565)>>8)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)(rgb565)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);}while(0);          
    }
}
...
void lcd_cross(Site_t site, uint16 len, uint16 Color)
{
    ...
    Size_t size;
    int16  stmp, etmp;
    uint16 w = ST7735S_get_w(), h = ST7735S_get_h();

    if (!((site . x < ST7735S_get_w()) && (site . y < ST7735S_get_h()))) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Board\\src\\VCAN_LCD.c", 87);   
...
void lcd_points          (Site_t *site, uint32 point_num, uint16 rgb565)                
{
    while(point_num--)
    {
...
void lcd_char(Site_t site, uint8 ascii, uint16 Color, uint16 bkColor)
{
    ...
    if(site.x > (ST7735S_get_w()-8) || site.y > (ST7735S_get_h()-16))
    {
        return;
    }
    ...
    for (pos = 0; pos < (((8+7)/8)*16); pos++)
    {
        ...
        temp = ((uint8_t *)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->ascii_8x16))) ))))[((ascii-0x20)*(((8+7)/8)*16))+pos];
        ...
        for(t = 0; t < 8; t++)
        {
            ...
            if(temp & 0x80)
            {
                do{do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)((Color)>>8)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)(Color)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);}while(0);
            }
            else
            {
                do{do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)((bkColor)>>8)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)(bkColor)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);}while(0);
            }
            temp <<= 1;
...
void lcd_str(Site_t site, uint8 *Str, uint16 Color, uint16 bkColor)
{
    while(*Str != '\0')
    {
        if(site.x > (ST7735S_get_w()-8) )
        {
            
            site.x = 0;
            site.y += 16;
        }
        if(site.y > (ST7735S_get_h()-16) )
        {
...
void lcd_img_gray(Site_t site, Size_t size, uint8 *img)
{
    ...
    {
        imgtemp     = (uint16) * (pimg++);
        imgtemp = ((uint16)((((uint8)(imgtemp)>>3)<<11)|(((uint8)(imgtemp)>>2)<<5)|((uint8)(imgtemp)>>3)));
        do{do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)((imgtemp)>>8)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)(imgtemp)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);}while(0);               
    }
}
...
void lcd_img_gray_z(Site_t site, Size_t size, uint8 *img, Size_t imgsize)
{
    ...
    for(y = 0; y < size.H; y++)
    {
        ...
        for(x = 0; x < size.W; x++)
        {
            ...
            temp = tempY + X;
            rgb = ((uint16)((((uint8)(pimg[temp])>>3)<<11)|(((uint8)(pimg[temp])>>2)<<5)|((uint8)(pimg[temp])>>3)));    
            do{do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)((rgb)>>8)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)(rgb)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);}while(0);
        }
    }
}
...
void lcd_img_binary(Site_t site, Size_t size, uint8 *img)
{
    ...
    while(total--)
    {
        ...
        while(bitindex--)
        {
            ...
            {
                do{do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)((0X0000)>>8)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)(0X0000)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);}while(0);      
            }
            else
            {
                do{do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)((0XFFFF)>>8)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);do { ((((Dtype *)(&(GPIOX[2]->PDOR )))->b3))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b2))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=0; (((Dtype *)(&(GPIOX[1]->PDOR )))->B[2])=(uint8)((uint8)(0XFFFF)); ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=0; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b5))=1; ((((Dtype *)(&(GPIOX[2]->PDOR )))->b4))=1; }while(0);}while(0);      
            }
        }
    }
}
