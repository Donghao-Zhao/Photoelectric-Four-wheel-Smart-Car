...
char ad4[]="R1:";
   ...
   asm(" CPSID i");;
   uart_init (((UART_Type *)(0x4006C000u)),115200);      
   ...
   ftm_pwm_init(((FTM_Type *)(0x4003A000u)),FTM_CH2,7300,0);
   ftm_pwm_init(((FTM_Type *)(0x4003A000u)),FTM_CH3,7300,0);
   ftm_pwm_init(((FTM_Type *)(0x4003A000u)),FTM_CH0,7300,0);
   ftm_pwm_init(((FTM_Type *)(0x4003A000u)),FTM_CH1,7300,0);
   ...
   ftm_pulse_init(((FTM_Type *)(0x40038000u)), FTM_PS_1, PTE7); 
   ftm_pulse_init(((FTM_Type *)(0x40039000u)), FTM_PS_1, PTE0); 
   ...
   pit_init(PIT0,7 * bus_clk_khz);;                               
   pit_init(PIT1,1 * bus_clk_khz);;
