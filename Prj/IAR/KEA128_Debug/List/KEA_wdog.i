...
extern void wdog_init_ms(uint16 ms);   
...
{
    if (!(ms > 0)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_wdog.c", 30);                                

    wdog_unlock();                                  

    ((((WDOG_Type *)(0x40052000u)))->TOVAL8B . TOVALH) = ms >> 8;                         
    ((((WDOG_Type *)(0x40052000u)))->TOVAL8B . TOVALL) = (uint8)ms;

    ((((WDOG_Type *)(0x40052000u)))->CS2) = ( 0
                 
                 | (((uint8_t)(((uint8_t)(1))<<0))&0x3u)   

               );
    ((((WDOG_Type *)(0x40052000u)))->CS1) = (0
                | 0x80u          
                | 0x20u      
                | 0x4u         
                | 0x2u        
...
void wdog_disable(void)
{
    ...
    ((((WDOG_Type *)(0x40052000u)))->TOVAL) = (((uint16_t)(((uint16_t)(0xE803))<<0))&0xFFFFu);

    ((((WDOG_Type *)(0x40052000u)))->CS2) = (((uint8_t)(((uint8_t)(0x01))<<0))&0x3u);
    ((((WDOG_Type *)(0x40052000u)))->CS1) = (0
                | 0x20u
                | (((uint8_t)(((uint8_t)(0x00))<<3))&0x18u)
                | 0x2u
                | 0x1u
               );
...
void wdog_feed(void)
{
    ...
    unsigned long   tmp = __get_PRIMASK();    
    ...
    ((((WDOG_Type *)(0x40052000u)))->CNT) = 0x02A6;
    ((((WDOG_Type *)(0x40052000u)))->CNT) = 0x80B4;
...
void wdog_unlock(void)
{
    ...
    ((((WDOG_Type *)(0x40052000u)))->CNT)  = 0x20C5;
    ((((WDOG_Type *)(0x40052000u)))->CNT)  = 0x28D9;
