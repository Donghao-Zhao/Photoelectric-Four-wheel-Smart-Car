...
void systick_delay(uint32 time)
{
    ...
    if (!(time <= (0xFFFFFFu >> 0))) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_SysTick.c", 154);  

    ((((SysTick_MemMapPtr)0xE000E010u))->CSR) = 0x00;                        

    ((((SysTick_MemMapPtr)0xE000E010u))->RVR) = time;                        

    ((((SysTick_MemMapPtr)0xE000E010u))->CVR) = 0x00;                        
    ...
    while( !(((((SysTick_MemMapPtr)0xE000E010u))->CSR) & 0x10000u));   
}
...
void systick_timing(uint32 time)
{
    ...
    if (!(time <= (0xFFFFFFu >> 0))) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_SysTick.c", 194);  
