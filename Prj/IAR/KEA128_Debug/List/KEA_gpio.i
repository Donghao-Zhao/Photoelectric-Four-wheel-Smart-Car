...
GPIO_MemMapPtr GPIOX[] = { ((GPIO_Type *)(0x400FF000u)), ((GPIO_Type *)(0x400FF040u)), ((GPIO_Type *)(0x400FF080u)) }; 
...
{
    GPIO_MemMapPtr gpiox = GPIOX[((ptxn)>>5)];

    ((gpiox)->PIDR)  &=  ~(1 << ((ptxn)&0x1f));

    
    if(  cfg == GPI )
    {
        
        ((gpiox)->PDDR) &= ~(1 << ((ptxn)&0x1f));       
    }
    else
    {
        
        ((GPIOX[((ptxn)>>5)])->PDDR) |= (1 << ((ptxn)&0x1f));        

        
        if(data == 0)
        {
            ((GPIOX[((ptxn)>>5)])->PDOR) &= ~(1 << ((ptxn)&0x1f));   
        }
        else
        {
            ((GPIOX[((ptxn)>>5)])->PDOR)  |= (1 << ((ptxn)&0x1f));   
...
{
    if (!((((((GPIOX[((ptxn)>>5)])->PDDR))>>(((ptxn)&0x1f)))&0x01) == GPO)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_gpio.c", 100); 
...
{
    if (!((((((GPIOX[((ptxn)>>5)])->PDDR))>>(((ptxn)&0x1f)))&0x01) == GPO)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_gpio.c", 124); 
    

    ((GPIOX[((ptxn)>>5)])->PTOR)  =  1 << (((ptxn)&0x1f));                 
...
{
    if (!((((((GPIOX[((ptxn)>>5)])->PDDR))>>(((ptxn)&0x1f)))&0x01) == GPI)) assert_failed("C:\\Users\\ZDH\\Desktop\\2018.6.20.21.23\\2018.6.20.21.23\\Chip\\src\\KEA_gpio.c", 141); 
    

    return ((((GPIOX[((ptxn)>>5)])->PDIR) >> ((ptxn)&0x1f)) & 0x01);        
}
