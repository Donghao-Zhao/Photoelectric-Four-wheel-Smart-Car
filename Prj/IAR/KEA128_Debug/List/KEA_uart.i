...
UART_MemMapPtr UARTN[3] = { ((UART_Type *)(0x4006A000u)), ((UART_Type *)(0x4006B000u)), ((UART_Type *)(0x4006C000u)) }; 
...
void uart_init (UARTn_e uratn, uint32 baud)
{
    ...
    {
    case (uint32_t)((UART_Type *)(0x4006A000u)):

        port_pull(PTA3, 1);
        port_pull(PTA2, 1);
        (((((SIM_Type *)(0x40048000u)))->PINSEL)) |= (1<<(7)) ;

        ((((SIM_Type *)(0x40048000u)))->SCGC) |= 0x100000u;      
        break;

    case (uint32_t)((UART_Type *)(0x4006B000u)):
        (((((SIM_Type *)(0x40048000u)))->PINSEL1)) &= ~(1<<(12)) ;

        ((((SIM_Type *)(0x40048000u)))->SCGC) |= 0x200000u;      
        break;


    case (uint32_t)((UART_Type *)(0x4006C000u)):
        (((((SIM_Type *)(0x40048000u)))->PINSEL1)) &= ~(1<<(13)) ;

        ((((SIM_Type *)(0x40048000u)))->SCGC) |= 0x400000u;      
        break;
    ...
    sbr = (uint16)((sysclk / 16 + baud / 2 ) / (baud ));                 
    if(sbr > 0x1FFF)sbr = 0x1FFF;                                       


    
    temp = uratn->BDH  & (~0x1Fu);           
    uratn->BDH = temp |  (((uint8_t)(((uint8_t)(sbr >> 8))<<0))&0x1Fu)  ;        
    uratn->BDL = (((uint8_t)(((uint8_t)(sbr))<<0))&0xFFu);                     
...
{
    uratn->C2 |= 0x20u;                          
    if(uratn == ((UART_Type *)(0x4006A000u)))
    {
        NVIC_EnableIRQ(UART0_IRQn);                  
    }
    else if(uratn == ((UART_Type *)(0x4006B000u)))
    {
        NVIC_EnableIRQ(UART1_IRQn);                  
    }
    else if(uratn == ((UART_Type *)(0x4006C000u)))
    {
...
{
    UARTn_e uratn = ((UART_Type *)(0x4006A000u));
