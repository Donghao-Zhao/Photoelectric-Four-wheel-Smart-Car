...
/********************* ST7735S内部实现 ***********************/
//LCD 的管脚定义
#define     LCD_ST7735S_WR      PTI5
#define     LCD_ST7735S_RD      PTI3
#define     LCD_ST7735S_CS      PTI4
#define     LCD_ST7735S_RS      PTI2
#define     LCD_ST7735S_RST     PTI6

#define     LCD_ST7735S_SPIN            PTG0
#define     LCD_ST7735S_P0              PTG_OUT
#define     LCD_ST7735S_PIN             PTG_IN
#define     LCD_ST7735S_PDDR_OUT()      (PTG_DDR = 0xff)
#define     LCD_ST7735S_PDDR_IN()       (PTG_DDR = 0)
