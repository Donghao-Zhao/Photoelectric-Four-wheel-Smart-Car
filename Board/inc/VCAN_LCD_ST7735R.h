...
/********************* ST7735R内部实现 ***********************/
//LCD 的管脚定义
#define     LCD_ST7735R_WR      PTI5
#define     LCD_ST7735R_RD      PTI3
#define     LCD_ST7735R_CS      PTI4
#define     LCD_ST7735R_RS      PTI2
#define     LCD_ST7735R_RST     PTI6

#define     LCD_ST7735R_SPIN            PTG0
#define     LCD_ST7735R_P0              PTG_OUT
#define     LCD_ST7735R_PIN             PTG_IN
#define     LCD_ST7735R_PDDR_OUT()      (PTG_DDR = 0xff)
#define     LCD_ST7735R_PDDR_IN()       (PTG_DDR = 0)
