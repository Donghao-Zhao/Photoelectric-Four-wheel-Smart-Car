...
#if 1             //宏条件编译选择不同的信号类型
ADCn_Ch_e   tsl1401_ch[] = {ADC0_SE0,     ADC0_SE2};       //CCD所用的 ADC通道(原始信号)
#else
ADCn_Ch_e   tsl1401_ch[] = {ADC0_SE1,     ADC0_SE3};       //CCD所用的 ADC通道(放大信号)
#endif
PTXn_e      tsl1401_si[] = {PTC0 ,        PTF0    };          //CCD所用的 SI管脚
PTXn_e      tsl1401_clk[] = {PTC1 ,        PTF1 };         //CCD所用的 SI管脚
PTXn_e      tsl1401_led[] = {PTC6 ,        PTC7 };         //CCD 补光 所用的 LED_EN 管脚
