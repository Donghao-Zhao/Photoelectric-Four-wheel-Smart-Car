...
//      模块通道    端口          可选范围              建议
#define FTM2_CH0_PIN    PTC0       //PTC0、PTF0、PTH0
#define FTM2_CH1_PIN    PTC1       //PTC1、PTF1、PTH1
#define FTM2_CH2_PIN    PTC2       //PTC2、PTD0、PTG4
#define FTM2_CH3_PIN    PTC3       //PTC3、PTD1、PTG5
#define FTM2_CH4_PIN    PTG6       //PTB4、PTG6       (B4是NMI中断引脚，有可能不稳定)
